...
impl Plugin for CellRendererPlugin {
    fn build(&self, app: &mut App) {
        app
        .add_startup_system(initialize_cells)
...
fn initialize_cells(
    ...
    let start_pos = Vec3::from(((CELL_SIZE / 2.0) - (BOARD_WIDTH / 2.0), (CELL_SIZE / 2.0) - (BOARD_HEIGHT / 2.0), 1.0));
        ...
        for row in 0..num_rows {
            commands.spawn((
                ...
                SpriteBundle {
                    ...
                    transform: Transform::from_translation(start_pos + Vec3::from((column as f32 * CELL_SIZE, row as f32 * CELL_SIZE, 0.0))),
                    ..default()
                }
            ));
        }
